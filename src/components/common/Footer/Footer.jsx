...
const Footer = () => {
    return (
        <footer className='flex flex-col md:flex-row h-fit gap-4 text-sm p-4 bg-[#858D7E] text-slate-100'>
            <p><strong>Novi Nest</strong> acknowledges the Traditional Custodians of the land on which we work, the Gadigal people of the Eora Nation peoples. We pay our deepest respect to elders past, present and emerging. 
